function Skills() {
    ...
    return (
        <div className="z-10 w-full bg-white py-12 text-center" id="skills">
            <div className="default-spacing flex flex-col gap-4">
                <span className="text-4xl font-bold mb-2">Skills</span>
                <span>Over the years I've worked with several differency stacks, and even more tools. Although some of them has been a few years, we never forget how to ride a bike, neither how to use a tool.</span>
                <div className="my-5 grid grid-rows-1 grid-cols-3 gap-8">
                    <div className="font-bold flex flex-col items-start gap-2">
                        <span className="text-2xl self-center">Frontend</span>
                        <span>Languages, Frameworks and Libraries</span>
                        ...
                        <span>Testing</span>
                        <div className="flex flex-wrap gap-2">
                            <img src="https://img.shields.io/badge/playwright-%232EAD33.svg?style=flat&logo=playwright&logoColor=white" alt="playwright" />
                            <img src="https://img.shields.io/badge/-selenium-%43B02A?style=flat&logo=selenium&logoColor=white" alt="selenium" />
                            <img src="https://img.shields.io/badge/-mocha-%238D6748?style=flat&logo=mocha&logoColor=white" alt="mocha" />
                            <img src="https://img.shields.io/badge/-Jasmine-%238A4182?style=flat&logo=Jasmine&logoColor=white" alt="jasmine" />
                            <img src="https://img.shields.io/badge/-TestingLibrary-%23E33332?style=flat&logo=testing-library&logoColor=white" alt="testing library" />
                            <img src="https://img.shields.io/badge/-jest-%23C21325?style=flat&logo=jest&logoColor=white" alt="jest" />
                        </div>
                    </div>
                    <div className="font-bold flex flex-col items-start gap-2">
                        <span className="font-bold text-2xl self-center">Backend</span>
                        <span>Languages, Frameworks and Libraries</span>
                        <div className="flex flex-wrap gap-2">
                            <img src="https://img.shields.io/badge/typescript-%23007ACC.svg?style=flat&logo=typescript&logoColor=white" alt="typescript" />
                            <img src="https://img.shields.io/badge/javascript-%23323330.svg?style=flat&logo=javascript&logoColor=%23F7DF1E" alt="javacript" />
                    ...
                    <div className="font-bold flex flex-col items-start gap-2">
                        <span className="text-2xl self-center">Others</span>
                        <span>Storage</span>
                        <div className="flex flex-wrap gap-2">
                            <img src="https://img.shields.io/badge/MongoDB-%234ea94b.svg?style=flat&logo=mongodb&logoColor=white" alt="MongoDB" />
                            <img src="https://img.shields.io/badge/postgres-%23316192.svg?style=flat&logo=postgresql&logoColor=white" alt="Postgress" />
                            <img src="https://img.shields.io/badge/redis-%23DD0031.svg?style=flat&logo=redis&logoColor=white" alt="Redis" />
                            <img src="https://img.shields.io/badge/Microsoft%20SQL%20Server-CC2927?style=flat&logo=microsoft%20sql%20server&logoColor=white" alt="Microsoft SQL" />
                            <img src="https://img.shields.io/badge/ClickHouse-FFCC01?style=flat&logo=clickhouse&logoColor=white" alt="ClickHouse" />
                        </div>
                        <span>Design</span>
                        <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <img src="https://img.shields.io/badge/SonarLint-CB2029?style=flat&logo=SONARLINT&logoColor=white" alt="SonarLint" />
